				...
				<div style={styles.contRight}>
					<div style={styles.contForm}>
						...
						<InputGroup className="mb-3">
							<InputGroup>
								<InputGroup id="basic-addon1" onClick={() => this.setState({ visibility2: !visibility2 })}>
...
const styles = {
	...
	contLeft: {
		...
		background: "url(https://images.unsplash.com/photo-1526045431048-f857369baa09?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80) no-repeat center",
